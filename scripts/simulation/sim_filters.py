...
run_auto_plots(str(bag_fn_single), uav_total, single, folder_png=str(png_dir), folder_pgf=str(pgf_dir))
...
run_auto_plots(str(bag_fn_multi), uav_total, single, folder_png=str(png_dir), folder_pgf=str(pgf_dir))